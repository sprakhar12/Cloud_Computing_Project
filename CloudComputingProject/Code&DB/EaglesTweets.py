...
cur = conn.cursor()
cur.execute("select * from cowboysvseagles")

# List Instantiate
myList = []
Eagles_List = ['#Eagles','#FlyEaglesFly', '#CowboysNation', '#PHIvsDAL', '#EaglesNation','#DallasCowboys']
myList2 = []
...
plt.title('Sentiment Analysis CowboysvsEagles Tweets')
...
plt.legend()
plt.tight_layout()
plt.savefig('CowboysVsEagles.png')
plt.show()
